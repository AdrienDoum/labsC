...
Creature::Creature(const Creature& creature)
	...
	pointDeVieTotal_(creature.pointDeVieTotal_), energieTotal_(creature.energieTotal_), experienceNecessaire_(creature.experienceNecessaire_)
{
...
const std::type_info & Creature::obtenirTypeCreature() const
{
	return typeid(*this);
}