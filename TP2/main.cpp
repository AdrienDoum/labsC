...
int main()
{
	...
	Dresseur* Sacha = new Dresseur("Sacha","Equipe de Poly");
	...
	// A COMPLETER...
	std::cout << Pokachu << std::endl << Touflamme << std::endl <<  Pokachoum << std::endl;
	...
	Pouvoir bouleDeFeu = Pouvoir("Boule de feu", 5, 5);
	Pouvoir pistoletAEau = Pouvoir("Pistolet a eau", 6, 6);
	Pouvoir eclair = Pouvoir("Eclair", 10, 5);
	// A COMPLETER...
	...
	// A COMPLETER...
	std::cout << bouleDeFeu << lanceFeuille << tonerre;
	...
	// Pokachum -> eclair
	Pokachoum.apprendrePouvoir(tonerre);
	// A COMPLETER...
	...
	std::cout << test1.obtenirNombreCreatures() << test2.obtenirNombreCreatures() << std::endl;
