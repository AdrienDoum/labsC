...
int main()
{
	...
	// A COMPLETER...
	salimouche.apprendrePouvoir(new Pouvoir(bouleDeFeu));
	pokachu.apprendrePouvoir(new Pouvoir(tonerre));
	pokachu.apprendrePouvoir(new Pouvoir(eclair));
	touflamme.apprendrePouvoir(new Pouvoir(tonerre));
